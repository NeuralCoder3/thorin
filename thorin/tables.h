...
#define THORIN_M_OP(m) m(MOp, vec) m(MOp, add) m(MOp, sub) m(MOp, div) m(MOp, mul) m(MOp, smul) m(MOp, sadd) m(MOp, ssub) m(MOp, sdiv) m(MOp, transpose) m(MOp, sum) m(MOp, init)
/// Type traits
